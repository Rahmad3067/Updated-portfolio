...
import { PortfolioSection } from "./data/portfolioSections";

interface PortfolioFloatingPlanetProps {
...
const PortfolioFloatingPlanet: React.FC<PortfolioFloatingPlanetProps> = ({
  section,
  isActive,
  onClick,
  showHtml,
...
export default PortfolioFloatingPlanet;
